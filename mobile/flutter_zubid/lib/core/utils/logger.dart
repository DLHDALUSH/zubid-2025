...
class AppLogger {
  ...
  /// API error logging
  static void apiError(String endpoint, int statusCode, String error, {StackTrace? stackTrace}) {
  ...
  /// Payment logging
  static void payment(String action, {String? amount, String? method, bool success = true}) {
    final icon = success ? '💳' : '❌';
  ...
  /// Bid logging
  static void bid(String action, {String? auctionId, String? amount, String? userId}) {
