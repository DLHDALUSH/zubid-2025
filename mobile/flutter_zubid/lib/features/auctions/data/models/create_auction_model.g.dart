...
CreateAuctionRequest _$CreateAuctionRequestFromJson(Map<String, dynamic> json) => CreateAuctionRequest(
      ...
      shippingInfo: ShippingInfo.fromJson(json['shippingInfo'] as Map<String, dynamic>),
      allowInternationalShipping: json['allowInternationalShipping'] as bool? ?? false,
      returnPolicy: json['returnPolicy'] as String?,
      handlingTime: json['handlingTime'] as int? ?? 1,
      autoRelist: json['autoRelist'] as bool? ?? false,
      relistCount: json['relistCount'] as int?,
    );

Map<String, dynamic> _$CreateAuctionRequestToJson(CreateAuctionRequest instance) => <String, dynamic>{
...
ShippingInfo _$ShippingInfoFromJson(Map<String, dynamic> json) => ShippingInfo(
      ...
      internationalShippingCost: (json['internationalShippingCost'] as num?)?.toDouble(),
      shippingMethod: json['shippingMethod'] as String,
      shipsTo: (json['shipsTo'] as List<dynamic>).cast<String>(),
...
Map<String, dynamic> _$ShippingInfoToJson(ShippingInfo instance) => <String, dynamic>{
...
CreateAuctionResponse _$CreateAuctionResponseFromJson(Map<String, dynamic> json) => CreateAuctionResponse(
...
Map<String, dynamic> _$CreateAuctionResponseToJson(CreateAuctionResponse instance) => <String, dynamic>{
